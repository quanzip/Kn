...
# JAVA HOME PATH
JAVA_HOME="/home/app/jdk1.8.0_281/jdk1.8.0_281"
...
# FOR DISABLING MAPPING MEMORY WHILE RUNNING APP
# JAVA OPT
JAVA_OPTS="-Djava.awt.headless=true -Dfile.encoding=UTF-8 -server -Xms1024m -Xmx8192m -Xss1024m -Dsun.zip.disableMemoryMapping=true -XX:+UseG1GC -XX:MaxGCPauseMillis=200 -XX:ParallelGCThreads=8 -XX:ConcGCThreads=2 -XX:InitiatingHeapOccupancyPercent=70 -XX:+UseStringDeduplication -XX:+DisableExplicitGC -Djava.net.preferIPv4Stack=true -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=9010 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
